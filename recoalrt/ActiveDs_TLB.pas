...
// $Rev: 8291 $
// File generated on 04.02.2012 14:36:03 from Type Library described below.
...
begin
  RegisterComponents(dtlServerPage, [TPropertyEntry, TPropertyValue, TAccessControlEntry, TAccessControlList, 
    TSecurityDescriptor, TLargeInteger, TNameTranslate, TPathname, TADSystemInfo, 
    TWinNTSystemInfo, TDNWithBinary, TDNWithString, TADsSecurityUtility]);
end;
